...
enum _descriptors {
    ...
    atsc_ac3_audio_stream_descriptor = 0x81, // a_52b.pdf 3.2 PES stream_id 0xBD (private_stream_1); descriptor ETSI TS 102366
                                             // chapter A2;
...
void parse_service_descriptor(
    unsigned char const *buf,
    struct service *s,
    char const *fallback_input_charset,
    unsigned int user_charset_id);
void parse_ca_identifier_descriptor(unsigned char const *buf, struct service *s);
void parse_ca_descriptor(unsigned char const *buf, struct service *s);
void parse_iso639_language_descriptor(unsigned char const *buf, struct service *s);
void parse_subtitling_descriptor(unsigned char const *buf, struct service *s);
void parse_network_name_descriptor(unsigned char const *buf, struct transponder *t);
void parse_frequency_list_descriptor(unsigned char const *buf, struct transponder *t);
void parse_cable_delivery_system_descriptor(unsigned char const *buf, struct transponder *t, fe_spectral_inversion_t inversion);
void parse_C2_delivery_system_descriptor(unsigned char const *buf, struct transponder *t, fe_spectral_inversion_t inversion);
void parse_S2_satellite_delivery_system_descriptor(unsigned char const *buf, void *dummy);
...
void parse_terrestrial_delivery_system_descriptor(
    ...
    struct transponder *t,
    fe_spectral_inversion_t inversion);
void parse_T2_delivery_system_descriptor(unsigned char const *buf, struct transponder *t, fe_spectral_inversion_t inversion);
void parse_SH_delivery_system_descriptor(unsigned char const *buf, struct transponder *t, fe_spectral_inversion_t inversion);
void parse_network_change_notify_descriptor(unsigned char const *buf, network_change_t *nc);
void parse_logical_channel_descriptor(unsigned char const *buf, struct transponder *t);
void parse_atsc_service_location_descriptor(struct service *s, unsigned char const *buf);
void parse_atsc_extended_channel_name_descriptor(struct service *s, unsigned char const *buf);

char const *network_id_desc(uint16_t network_id);
