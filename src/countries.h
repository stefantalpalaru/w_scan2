...
enum offset_type_t { NO_OFFSET = 0, POS_OFFSET = 1, NEG_OFFSET = 2, POS_OFFSET_1 = 3, POS_OFFSET_2 = 4, STOP_OFFSET_LOOP = -1 };
...
int choose_country(char const *country, int *atsc, int *dvb_cable, uint16_t *scan_type, int *channellist);

int txt_to_country(char const *id);

char const *country_to_short_name(int idx);
char const *country_to_full_name(int idx);
